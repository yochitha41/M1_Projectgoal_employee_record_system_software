    ...
    */
    ...
    while(1)
    {
        ...
        case '2':
            ...
            {
            	printf("\nEnter the employee name: %s",e.name);
            	printf("\nEnter the employee age: %d",e.age);
            	printf("\nEnter the emplyee basic salary: %.2f",e.bs);
                //printf("\n%s \n %d \n %.2f",e.name,e.age,e.bs); /// print the name, age and basic salary
            }
            getch();
            break;
